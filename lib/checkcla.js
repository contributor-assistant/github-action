    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (error.status === 404) {
                ...
                const promise = yield Promise.all([createFile(pathToClaSignatures, initalContentBinary, branch), pullRequestComment_1.default(signed, committerMap, committers, pullRequestNo)]);
                if (promise) {
