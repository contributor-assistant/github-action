    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (error.status === 404) {
                ...
                const promise = Promise.all([createFile(pathToClaSignatures, initialContentBinary, branch), pullRequestComment_1.default(signed, committerMap, committers, pullRequestNo)]);
                if (promise) {
