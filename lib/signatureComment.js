...
function signatureWithPRComment(commentId, committerMap, committers, pullRequestNo) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (github_1.context.eventName === "issue_comment") {
            ...
            core.debug(JSON.stringify(github_1.context.payload.comment.user.login.id));
            if (commentedCommitterMap.newSigned.some(contributor => contributor.id === github_1.context.payload.comment.user.login.id)) {
