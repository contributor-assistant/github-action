...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            core.debug("printing the context" + JSON.stringify(github_1.context, null, 2));
            const defaultUrl = `https://github.com/${github_1.context.repo.owner}/${github_1.context.repo.repo}/commit/${github_1.context.sha}/checks`;
